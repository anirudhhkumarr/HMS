				...
				if(filled){
					...
					if (ValidateDate(meeting_date))
					{
						...
						if(Date.parse(today_date) > Date.parse(meeting_date)){
							...
							$.post("<?php echo base_url("meeting/propose_meeting");?>",{meeting_proposer:meeting_proposer,meeting_type:meeting_type,meeting_subject:meeting_subject,meeting_description:meeting_description,meeting_date:meeting_date}, function(response){
